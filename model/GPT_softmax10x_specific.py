...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_Q, input_K, input_V, attn_mask):
        ...
        self.attn = 10 * torch.matmul(self.Q, self.K.transpose(-1, -2)) / np.sqrt(self.d_k)
...
class myGPT_softmax10x_specific(nn.Module):
    def __init__(self, args, device):
        super(myGPT_softmax10x_specific, self).__init__()
